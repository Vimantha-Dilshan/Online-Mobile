...
<div class="progress rounded-0">
  ...
  <!-- NAV BAR END -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="server/APIs/edit_item.php">
                ...
                $sql = "SELECT * FROM stock_items WHERE id='$pid'";
                $result = $conn->query($sql);
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "
                                ...
                                <input type='text' class='form-control' name='txtProductName' id='txtProductName' value='" . $row["product_name"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Brand</label>
                                <input type='text' class='form-control' name='txtBrand' id='txtBrand' value='" . $row["brand"] . "' disabled>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <select class='form-select' id='txtCategory' name='txtCategory' disabled>
                                ...
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Seller</label>
                                <select class='form-select' id='txtSeller' name='txtSeller' disabled>
                            ...
                            <div class='row'>
                                ...
                                <div class='input-group has-validation'>
                                    ...
                                    <input type='text' class='form-control' id='txtBuyingPrice' name='txtBuyingPrice' aria-describedby='inputGroupPrepend' placeholder='/piece' value='" . $row["buying_price"] . "' disabled>
                                    <div class='invalid-feedback'>
                                ...
                                <div class='input-group has-validation'>
                                    <span class='input-group-text' id='inputGroupPrepend'>Rs.</span>
                                    <input type='text' class='form-control' id='txtSellingPrice' name='txtSellingPrice' aria-describedby='inputGroupPrepend' placeholder='/piece' value='" . $row["selling_price"] . "' disabled>
                                    <div class='invalid-feedback'>
                            ...
                            <div class='row'>
                                ...
                                <select class='form-select' id='txtStatus' name='txtStatus' disabled>
                                ...
                                <input type='date' class='form-control' name='txtDate' id='txtDate' value='" . $row["date"] . "' disabled> 
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Quanitity</label>
                                <input type='number' class='form-control' name='txtQty' id='txtQty' value='" . $row["quantity"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <div class='form-check mb-3'>
                                    <input type='checkbox' class='form-check-input' id='txtImportModel' name='txtImportModel' value='" . $row["import_model"] . "' disabled>
        ...
        <a href="stock_management.php"><button type="button" class="btn btn-outline-success" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
        </div>
    </div>
    </div>
    </div>
