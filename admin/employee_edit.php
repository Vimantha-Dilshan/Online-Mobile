  ...
  <!-- NAV BAR END -->
    ...
    <div class="card">
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <br>
                                ...
                                <input type='text' class='form-control' name='txtName' id='txtName' value='" . $row["name"] . "'>
                                </div>
                                <div class='col-sm-6'>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtNic' id='txtNic' value='" . $row["nic"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Mobile 01</label>
                                <input type='text' class='form-control' name='txtMobile01' id='txtMobile01' value='" . $row["mobile_01"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtMobile02' id='txtMobile02' value='" . $row["mobile_02"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Birthday</label>
                                <input type='date' class='form-control' name='txtBirthday' id='txtBirthday' value='" . $row["birthday"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtStatus' id='txtStatus' value='" . $row["status"] . "'>
                                </div>
                                <div class='col-sm-6'>
        ...
        <a href="employee.php"><button type="button" class="btn btn-outline-success" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
            <button type="submit" class="btn btn-success"><i class="bi bi-pen-fill"></i> Edit Employee</button>
        </div>
    </div>
    </div>
    </div>
