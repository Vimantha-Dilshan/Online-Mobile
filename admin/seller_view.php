...
<div class="progress rounded-0">
  ...
  <!-- NAV BAR END -->
    ...
    <!-- CONTENT START -->
    <div class="card">
        <h5 class="card-header">Edit View</h5>
        <div class="card-body">
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <br>
                                ...
                                <input type='text' class='form-control' name='txtCompany' id='txtCompany' value='" . $row["company"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtTelephone01' id='txtTelephone01' value='" . $row["telephone_01"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Telephone 02</label>
                                <input type='text' class='form-control' name='txtTelephone02' id='txtTelephone02' value='" . $row["telephone_02"] . "' disabled>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtToPay' id='txtToPay' value='" . $row["to_pay"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Paid Amount</label>
                                <input type='text' class='form-control' name='txtPaidAmount' id='txtPaidAmount' value='" . $row["paid_amount"] . "' disabled>
                                </div>
                            </div>
