            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header">
                        <b><i class="bi bi-earbuds"></i> Add Product</b>
                    </div>
                    <div class="card-body">
                        <br>

                        <form method="POST" action="server/APIs/store_site_product.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col">
                                    <label for="inputFName" class="form-label text-secondary">Product Name</label>
                                    <input type="text" class="form-control" id="txtProductName" name="txtProductName" required>
                                </div>
                                <div class="col">
                                    <label for="inputFName" class="form-label text-secondary">Category</label>
                                    <select class="form-select" aria-label="Default select example" id="txtCategory" name="txtCategory" required>
                                ...
                                <div class="col">
                                    <label for="inputFName" class="form-label text-secondary">Selling Price</label>
                                    <input type="number" class="form-control" id="txtPrice" name="txtPrice" required>
                                </div>
                                <div class="col">
                                    <label for="inputLName" class="form-label text-secondary">Product Image</label>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex flex-row-reverse">
                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                        ...
                                        <button type="submit" name="upload" id="upload" class="btn btn-sm btn-danger"><i class="bi bi-plus-circle"></i> Add Product</button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <ol class="list-group list-group-numbered">
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="badge bg-success rounded-pill">279 Pixels</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            <div class="ms-2 me-auto">
                                                <div class="fw-bold">Height</div>
                                            </div>
                                            <span class="badge bg-success rounded-pill">364 Pixels</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-start">
                                            <div class="ms-2 me-auto">
                                ...
                                <tbody class="text-secondary">
                                    ...
                                    if ($result->num_rows > 0) {
                                        if (!$conn) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                $imageSrc = "server/APIs/images/" . $row["image"];
                                                ...
                                                echo "<td>" . "<a target='_blank' href='site_product_view.php?rn=$row[id]'><button type='button' class='btn btn-sm btn-outline-secondary'><i class='bi bi-info-circle'></i></button></a>" . " " . "<a href='server/APIs/delete_site_product.php?rn=$row[id]'><button type='button' class='btn btn-sm btn-outline-danger'><i class='bi bi-trash3'></i></button></a>" . "</td>";
                                                echo "<tr>";
                                            }
                                        }
                                    } else {
                                        echo "<tr>";
                                        echo "<td colspan='3'>" . "<p>No products to show!<p>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
