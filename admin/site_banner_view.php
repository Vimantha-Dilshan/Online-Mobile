...
<body>
    ...
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header">View Site Banner</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <form method="POST" action="server/APIs/edit_seller.php">
                            ...
                            $sql = "SELECT * FROM banners WHERE id='$pid'";
                            $result = $conn->query($sql);
                            ...
                            if ($result->num_rows > 0) {
                                if (!$conn) {
                                    ...
                                    <div class='row'>
                                        <div class='col-sm-6'>               
                                            <label for='inputAddress'>Banner Title</label>
                                            <input type='text' class='form-control' name='txtName' id='txtName' value='" . $row["title"] . "' disabled>
                                        </div>
                                        <div class='col-sm-6'>               
                                            <label for='inputAddress'>Banner Sub-Title</label>
                                            <input type='text' class='form-control' name='txtCategory' id='txtCategory' value='" . $row["sub_title"] . "' disabled>
                                        </div>
                                    </div>
                                ...
                                <br>
                                    ...
                                    <div class='col-sm-12'>
                                        ...
                                        <textarea class='form-control' rows='10' name='Description' id='txtDescription' value='" . $row["description"] . "' disabled>" . $row["description"] . "</textarea>
                                    </div>
                                </div>
                            ...
                            <a href="site_banners.php"><button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
                        </form>
                    </div>
                                    ...
                                    if ($result->num_rows > 0) {
                                        if (!$conn) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<img class='product_view' src='server/APIs/images/banners/".$row["image"]."'>";
                                            }
                                        }
                                    } else {
                                        echo "<tr>";
                                        echo "<td colspan='8'>" . "<p>No Image available<p>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
