...
<div class="progress rounded-0">
  ...
  <!-- NAV BAR END -->
    ...
    <!-- CONTENT START -->
    <div class="card">
        <h5 class="card-header">View Promo Users</h5>
        <div class="card-body">
            <form method="POST" action="server/APIs/edit_promo_user.php">
                ...
                $sql = "SELECT * FROM promo_users WHERE id='$pid'";
                $result = $conn->query($sql);
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <br>
                                ...
                                <input type='text' class='form-control' name='txtFirstName' id='txtFirstName' value='" . $row["first_name"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Last Name</label>
                                <input type='text' class='form-control' name='txtLastName' id='txtLastName' value='" . $row["last_name"] . "' disabled>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtMobile' id='txtMobile' value='" . $row["mobile"] . "' disabled>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Promo Value</label>
                                <input type='text' class='form-control' name='txtPromoValue' id='txtPromoValue' value='" . $row["promo_value"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>last_purchase</label>
                                <input type='text' class='form-control' name='txtLastPurchase' id='txtLastPurchase' value='" . $row["last_purchase"] . "' disabled>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtDate' id='txtDate' value='" . $row["date"] . "' disabled>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Added By</label>
                                <select class='form-select' id='txtAddedBy' name='txtAddedBy' disabled>
                                    <option selected value='" . $row["added_by"] . "'>" . $row["added_by"] . "</option>
                                    <option>Pathum</option>
                                    <option>Admin</option>
                                </select>
