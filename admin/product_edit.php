  ...
  <!-- NAV BAR END -->
    ...
    <div class="card">
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "
                                <div class='row'>
                                    ...
                                    <input type='text' class='form-control' name='txtID' id='txtID' value='" . $row["id"] . "'>
                                </div>
                            ...
                            <br>
                                ...
                                <input type='text' class='form-control' name='txtProductName' id='txtProductName' value='" . $row["product_name"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Brand</label>
                                <input type='text' class='form-control' name='txtBrand' id='txtBrand' value='" . $row["brand"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <div class='input-group has-validation'>
                                    ...
                                    <input type='text' class='form-control' id='txtBuyingPrice' name='txtBuyingPrice' aria-describedby='inputGroupPrepend' placeholder='/piece' value='" . $row["buying_price"] . "' required>
                                    <div class='invalid-feedback'>
                                ...
                                <div class='input-group has-validation'>
                                    <span class='input-group-text' id='inputGroupPrepend'>Rs.</span>
                                    <input type='text' class='form-control' id='txtSellingPrice' name='txtSellingPrice' aria-describedby='inputGroupPrepend' placeholder='/piece' value='" . $row["selling_price"] . "' required>
                                    <div class='invalid-feedback'>
                            ...
                            <div class='row'>
                                ...
                                <input type='date' class='form-control' name='txtDate' id='txtDate' value='" . $row["date"] . "'> 
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='number' class='form-control' name='txtQty' id='txtQty' value='" . $row["quantity"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <div class='form-check mb-3'>
                                    <input type='checkbox' class='form-check-input' id='txtImportModel' name='txtImportModel' value='" . $row["import_model"] . "'>
        ...
        <a href="stock_management.php"><button type="button" class="btn btn-outline-success" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
            <button type="submit" class="btn btn-success"><i class="bi bi-pen-fill"></i> Edit Product</button>
        </div>
    </div>
    </div>
    </div>
