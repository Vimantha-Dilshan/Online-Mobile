...
<div class="progress rounded-0">
  ...
  <!-- NAV BAR END -->
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="server/APIs/edit_seller.php">
                ...
                $sql = "SELECT * FROM seller_details WHERE id='$pid'";
                $result = $conn->query($sql);
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <br>
                                ...
                                <input type='text' class='form-control' name='txtCompany' id='txtCompany' value='" . $row["company"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Address</label>
                                <input type='text' class='form-control' name='txtAddress' id='txtAddress' value='" . $row["address"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Telephone 01</label>
                                <input type='text' class='form-control' name='txtTelephone01' id='txtTelephone01' value='" . $row["telephone_01"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Telephone 02</label>
                                <input type='text' class='form-control' name='txtTelephone02' id='txtTelephone02' value='" . $row["telephone_02"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>To Pay</label>
                                <input type='text' class='form-control' name='txtToPay' id='txtToPay' value='" . $row["to_pay"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Paid Amount</label>
                                <input type='text' class='form-control' name='txtPaidAmount' id='txtPaidAmount' value='" . $row["paid_amount"] . "'>
                                </div>
                            </div>
        ...
        <a href="stock_management.php"><button type="button" class="btn btn-outline-success" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
            <button type="submit" class="btn btn-success"><i class="bi bi-pen-fill"></i> Edit Seller</button>
        </div>
    </div>
    </div>
    </div>
