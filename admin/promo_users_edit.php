...
<div class="progress rounded-0">
  ...
  <!-- NAV BAR END -->
    ...
    <!-- CONTENT START -->
    <div class="card">
        <h5 class="card-header">Edit Promo Users</h5>
        <div class="card-body">
                    ...
                    if (!$conn) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtMobile' id='txtMobile' value='" . $row["mobile"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtPromoValue' id='txtPromoValue' value='" . $row["promo_value"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>last_purchase</label>
                                <input type='text' class='form-control' name='txtLastPurchase' id='txtLastPurchase' value='" . $row["last_purchase"] . "'>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <input type='text' class='form-control' name='txtDate' id='txtDate' value='" . $row["date"] . "'>
                                </div>
                                <div class='col-sm-6'>
                                <label for='inputAddress'>Added By</label>
                                <select class='form-select' id='txtAddedBy' name='txtAddedBy' required>
        ...
        <a href="stock_management.php"><button type="button" class="btn btn-outline-success" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
            <button type="submit" class="btn btn-success"><i class="bi bi-pen-fill"></i> Edit Promo User</button>
        </div>
    </div>
    </div>
    </div>
