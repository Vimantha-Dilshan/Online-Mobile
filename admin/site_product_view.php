...
<body>
    ...
    <div class="container-fluid">
        <div class="card">
            <h5 class="card-header">View Site Product</h5>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <form method="POST" action="server/APIs/edit_seller.php">
                                ...
                                if (!$conn) {
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-3'>               
                                            ...
                                            <input type='text' class='form-control' name='txtCategory' id='txtCategory' value='" . $row["category"] . "' disabled>
                                        </div>
                                        <div class='col-sm-3'>
                                            <label for='inputAddress'>Selling Price</label>
                                            <input type='number' class='form-control' name='txtPrice' id='txtPrice' value='" . $row["price"] . "' disabled>
                                        </div>
                                        <div class='col-sm-3'>
                            ...
                            <a href="site_products.php"><button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal"><i class="bi bi-x-lg"></i> Close</button></a>
                        </form>
                    </div>
                                    ...
                                    if ($result->num_rows > 0) {
                                        if (!$conn) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<img class='product_view' src='server/APIs/images/".$row["image"]."'>";
                                            }
                                        }
                                    } else {
                                        echo "<tr>";
